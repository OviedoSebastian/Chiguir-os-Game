...
export default function World(props) {
    ...
    return (
      ...
      <group>
        ...
        <mesh geometry={nodes['1I'].geometry} material={nodes['1I'].material} />
        <mesh geometry={nodes['2D'].geometry} material={nodes['2D'].material} />
        <mesh geometry={nodes['3I'].geometry} material={nodes['3I'].material} />
        <mesh geometry={nodes['4I'].geometry} material={nodes['4I'].material} />
        <mesh geometry={nodes['5D'].geometry} material={nodes['5D'].material} />
        <mesh geometry={nodes['6I'].geometry} material={nodes['6I'].material} />
        <mesh geometry={nodes['7D'].geometry} material={nodes['7D'].material} />
        <mesh geometry={nodes['8D'].geometry} material={nodes['8D'].material} />
        <mesh geometry={nodes['9I'].geometry} material={nodes['9I'].material} />
