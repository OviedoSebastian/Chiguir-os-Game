...
export default function AvatarEngineer() {
  ...
  useFrame(() => {
    if (avatarRef.current) {
      console.log(
        "Posición del avatar:",
        avatar.rigidBodyObject?.translation()
      );
      // console.log('Rotación del avatar:', avatarRef.current.rotation());
    }
  });

  //   const posicion = avatar.Scene?.translation();
  ...
  return (
    <Ecctrl
      ...
      position={[20, 5, -30]}
    >
      <group ref={avatarRef} name="EngineerS" position-y={-0.82}>
